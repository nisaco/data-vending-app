...
profitToCredit += itemProfit;
        ...
        // --- PHASE 3: CREDIT AGENT PROFIT (If applicable) ---
        if (user.role === 'Agent' && profitToCredit > 0) {
            await User.findByIdAndUpdate(userId, { $inc: { payoutWalletBalance: profitToCredit } });
        }
