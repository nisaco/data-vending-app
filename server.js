...
// 🛑 MODIFIED: This function now ONLY calculates the total amount the client MUST be charged, 
...
    // Math.ceil ensures the charged amount is slightly higher, minimizing float errors
...
        // 🛑 CRITICAL FIX: Removed the tight equality check due to floating point and dynamic fees.
        // Instead, we check if the verified amount is within 5% of the *expected* charge.
