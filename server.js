...
// --- 2. DATA (PLANS) AND MAPS (omitted for brevity, unchanged) ---
const allPlans = {
    "MTN": [
        { id: '1', name: '1GB', price: 490 }, { id: '2', name: '2GB', price: 980 }, { id: '3', name: '3GB', price: 1400 }, 
        { id: '4', name: '4GB', price: 1820 }, { id: '5', name: '5GB', price: 2300 }, { id: '6', name: '6GB', price: 2700 }, 
        { id: '8', name: '8GB', price: 3600 }, { id: '10', name: '10GB', price: 4200 }, { id: '15', name: '15GB', price: 6300 },
        { id: '20', name: '20GB', price: 8200 }, { id: '25', name: '25GB', price: 10200 }, { id: '30', name: '30GB', price: 12200 },
        { id: '40', name: '40GB', price: 16300 }, { id: '50', name: '50GB', price: 19700 }
    ],
    "AirtelTigo": [
...
function calculatePaystackFee(chargedAmountInPesewas) {
    const TRANSACTION_FEE_RATE = 0.0022; // ⬅️ UPDATED: 0.22%
    const TRANSACTION_FEE_CAP = 2000;
    
    // This function must calculate the actual fee Paystack charges you (1.9% + 80p)
    // The client-side logic calculates what the customer pays (Price + 0.22% + 15p).
    // For *your* financial reports, we need the true Paystack deduction.
    // We will keep the original fee structure for profitability calculation,
    // as the amount you charge the customer is irrelevant to what Paystack deducts from the total transaction amount.
    
    // We assume the customer is charged the transaction amount. Paystack takes 1.9% + 80p from that amount.
    const TRUE_PAYSTACK_RATE = 0.019;
    
    let fullFee = (chargedAmountInPesewas * TRUE_PAYSTACK_RATE) + 80; // Use true 1.9% rate
